...
@export var hit_value : float = 1.0 # when calculating dmg, this affects how likely attack is to hit (if high dodge)
@export var dodge : float = 0.0 # when calculating dmg, this affects how likely the attack is to do no dmg
